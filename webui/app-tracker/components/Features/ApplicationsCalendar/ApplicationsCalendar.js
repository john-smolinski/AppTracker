...
import styles from "./ApplicationsCalendar.module.css";
      ...
      <div className={styles["calendar"]}>
        ...
        <div>
          {monthLabels.map((month) => (
            <div
              key={month.weekIndex}
              className={styles["calendar-month-label"]}
        ...
        {/* Weekday Labels */}
        <div className={styles["calendar-weekday-labels"]}>
          {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map(
            (day, index) => (
              <div key={index} className={styles["calendar-weekday-label"]}>
                {day}
              </div>
            )
          )}
